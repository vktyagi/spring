...
@ContextConfiguration("classpath:test-app-context-no_enc.xml")
@RunWith(SpringJUnit4ClassRunner.class)
public class ExampleConfigurationTests_NoEnc {
	...
	public void testSimpleMessageSec() throws Exception {
		assertEquals("ENC(ye6+Fj6rMfZadQPzU5j2iQ==)", exampleService.getMessageFromPropertiesEncrypted());
	}

	@Test
	public void testSimpleMessageSecFail() throws Exception {
		assertFalse("Encoded string match", "totaltag".equals(exampleService.getMessageFromPropertiesEncrypted()));     
	}
